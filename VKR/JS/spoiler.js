...
var timer = 10;
 ...
 var section = array[i];
 var head = document.getElementById(section + '-spheader');
...
function spoiler(target,showfirst) {
 var spoiler = document.getElementById(target);
 var divs = spoiler.getElementsByTagName('div');
 var divslength = divs.length;
 for(i = 0; i < divslength; i++) {
 var div = divs[i];
 var divid = div.id;
 if(divid.indexOf("spheader") != -1) {
